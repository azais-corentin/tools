import { wifi, url, email, sms, geo, phone, vcard, mecard, event, swissQR, gs1DigitalLink } from 'etiket';
...
export const HELPERS: HelperDef[] = [
	{
		...
		label: 'Wi-Fi network',
		fields: [
			{ name: 'ssid', label: 'Network name (SSID)', type: 'text', required: true, default: 'MyNetwork' },
			...
			{ name: 'hidden', label: 'Hidden network', type: 'select', default: 'false', options: YES_NO }
		],
		render: (v, s) =>
	...
	},
	{
		id: 'url',
		label: 'URL',
		fields: [{ name: 'url', label: 'URL', type: 'text', required: true, default: 'https://example.com' }],
		render: (v, s) => url(v.url, qr(s))
	},
	{
		id: 'email',
		label: 'Email',
		fields: [{ name: 'address', label: 'Email address', type: 'text', required: true, default: 'hi@example.com' }],
	...
	},
	{
		...
		label: 'SMS',
		fields: [
			{ name: 'number', label: 'Phone number', type: 'text', required: true, default: '+15551234567' },
	...
	},
	{
		id: 'phone',
		label: 'Phone',
		fields: [{ name: 'number', label: 'Phone number', type: 'text', required: true, default: '+15551234567' }],
	...
	},
	{
		...
		fields: [
			...
			{ name: 'start', label: 'Start', type: 'datetime', required: true, default: '2026-06-08T10:00' },
	...
	},
	{
		...
		label: 'Swiss QR-bill',
		fields: [
			{ name: 'iban', label: 'IBAN', type: 'text', required: true, default: 'CH4431999123000889012' },
			{ name: 'creditorName', label: 'Creditor name', type: 'text', required: true, default: 'Max Muster' },
			{ name: 'creditorPostalCode', label: 'Creditor postal code', type: 'text', required: true, default: '8000' },
			{ name: 'creditorCity', label: 'Creditor city', type: 'text', required: true, default: 'Zürich' },
			{ name: 'creditorCountry', label: 'Creditor country', type: 'text', required: true, default: 'CH' },
